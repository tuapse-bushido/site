...
import { ButtonCardMain } from 'old/components/product/product-card/button-card/button-card-main';
import { ProductCardViewProps } from 'old/components/product/product-card/product-card-view/product-card-view.props';
